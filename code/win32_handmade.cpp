...
internal void Win32ClearBuffer(win32_sound_output *SoundOutput, DWORD ByteToLock, DWORD BytesToWrite)
{
    VOID *Region1;
    DWORD Region1Size;
    VOID *Region2;
...
//    WindowClass.hIcon;
    ...
    if(RegisterClassA(&WindowClass))
    {
        ...
        if(Window)
        {
            ...
            Win32ClearBuffer(&SoundOutput, 0, SoundOutput.SecondaryBufferSize);
